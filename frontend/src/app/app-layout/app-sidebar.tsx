...
export function AppSidebar() {
  ...
  React.useEffect(() => {
    animate(
      'span',
      { opacity: +!cfg.sidebarMinized, display: cfg.sidebarMinized ? 'none' : 'block' },
  ...
  return (
    <div
      ...
      style={{
        width: cfg.sidebarMinized ? '76px' : '175px'
      }}
    >
      <AppTitleBar />
      <Nav />
...
function TwitterLink() {
  ...
  return (
    <button
      onClick={() => BrowserOpenURL('https://github.com/Nunslayer/heroku-gen15-milodev')}
...
function MinimizeButton() {
  ...
  return (
    <button
      ...
      onClick={() => {
        SaveSidebarMinimized(!cfg.sidebarMinized)
          .then(() => setCfg({ ...cfg, sidebarMinized: !cfg.sidebarMinized }))
          .catch(setError)
      }}
    >
      <Icon
        ...
        style={{ transform: cfg.sidebarMinized ? 'rotate(-180deg)' : 'none' }}
      />
